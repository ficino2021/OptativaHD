...
`<figure>`
`<figDesc>` Imágen con la bandera de Reino Unido de fondo y con una frase que dice: over 5.8 MILLION PEOPLE VACCINATED `</figDesc>`
`</figure>`
`<creationDate>` 23/01/2021 `</creationDate>`
`</lang>`
`</interp>`
`</tweetText>`
...
<blockquote class="twitter-tweet"><p lang="und" dir="ltr"><a href="https://t.co/Uxa7dDmyl0">pic.twitter.com/Uxa7dDmyl0</a></p>&mdash; Boris Johnson (@BorisJohnson) <a href="https://twitter.com/BorisJohnson/status/1354147835369959435?ref_src=twsrc%5Etfw">January 26, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
BORIS JHONSON PRIME MINISTER of the UNITED KINDOM
`</figDesc>`
`</figure>`
`<creationDate>` 26/01/2021 `</creationDate>`
`</lang>`
